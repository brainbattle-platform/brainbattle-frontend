...
import { Download, X, CheckCircle2, XCircle, Trash2 } from "lucide-react";

export function LearnerBulkActionsBar({
  count,
  onActivate,
  onSuspend,
  onDelete,
  ...
  return (
    <div
      className="
        sticky top-[72px] z-20 rounded-2xl bg-white border border-gray-200 shadow-sm
        px-4 py-3 flex flex-col md:flex-row md:items-center md:justify-between gap-3
      "
    >
