...
public class FFmpegKitFlutterPlugin implements FlutterPlugin, ActivityAware, MethodCallHandler, EventChannel.StreamHandler {
    ...
    // V1 embedding removed - only V2 embedding supported
    ...
    public void onAttachedToActivity(@NonNull ActivityPluginBinding activityPluginBinding) {
        ...
        // Register activity result listener for document selection
    ...
    // Activity result handling moved to ActivityPluginBinding.ActivityResultListener
    // This is registered in onAttachedToActivity via activityBinding.addActivityResultListener
    ...
    protected void uninit() {
        ...
        if (this.activityPluginBinding != null && activityResultListener != null) {
